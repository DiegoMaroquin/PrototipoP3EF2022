...
import rrhh.modelo.daoTipo_jugador;
 ...
 * @author visitante
 */
public class frmTipojugador extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("ID_TIPO_JUGADOR");
        modelo.addColumn("NOMBRE_POSICION");
        
        
        daoTipo_jugador cargoDAO = new daoTipo_jugador();
        List<clsTIpo_jugador> cargos = cargoDAO.select();
        tablaCargos.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < cargos.size(); i++) {
            dato[0] = Integer.toString(cargos.get(i).getid_tipo());
            dato[1] = cargos.get(i).getnombre_pos();
    ...
    public void buscarCargo() {
        clsTIpo_jugador cargoAConsultar = new clsTIpo_jugador();
        daoTipo_jugador cargoDAO = new daoTipo_jugador();
        cargoAConsultar.setid_tipo(Integer.parseInt(txtbuscado.getText()));
        cargoAConsultar = cargoDAO.query(cargoAConsultar);
        txtNombre.setText(cargoAConsultar.getnombre_pos());   
    ...
    private void initComponents() {
        ...
        tablaCargos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_TIPO_JUGADOR", "NOMBRE_POSICION"
            }
        ) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoTipo_jugador cargoDAO = new daoTipo_jugador();
        clsTIpo_jugador cargoAEliminar = new clsTIpo_jugador();
        cargoAEliminar.setid_tipo(Integer.parseInt(txtbuscado.getText()));
...
//        daocargo cargoDAO = new daocargo();
         daoTipo_jugador cargoDAO = new daoTipo_jugador();        
         clsTIpo_jugador cargoAInsertar = new clsTIpo_jugador();
        cargoAInsertar.setnombre_pos(txtNombre.getText());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // TODO add your handling code here:
        daoTipo_jugador cargoDAO = new daoTipo_jugador();
        clsTIpo_jugador cargoAActualizar = new clsTIpo_jugador();
        cargoAActualizar.setid_tipo(Integer.parseInt(txtbuscado.getText()));
        cargoAActualizar.setnombre_pos(txtNombre.getText());
