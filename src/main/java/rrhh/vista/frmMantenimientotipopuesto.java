...
import rrhh.modelo.daotipopuesto;
 ...
 * @author visitante
 */
public class frmMantenimientotipopuesto extends javax.swing.JInternalFrame {

    public void llenadoDeCombos() {
        daotipopuesto EmpleadoDAO = new daotipopuesto();
        List<clstipopuesto> empleados = EmpleadoDAO.select();
        cbox_trabajadores.addItem("Seleccione una opción");
        for (int i = 0; i < empleados.size(); i++) {
            cbox_trabajadores.addItem(empleados.get(i).getnombre_puesto());
        }
    }
    ...
    public void estado() {    
        ...
        cbox_estado.addItem("2000");
        cbox_estado.addItem("1000");
    }
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("ID_TIPO_PUESTO");
       ...
       modelo.addColumn("SALARIO");
        ...
        for (int i = 0; i < empleados.size(); i++) {
           ...
           dato[0] = Integer.toString(empleados.get(i).getid_puesto());
            dato[1] = empleados.get(i).getnombre_puesto();
            dato[2] = empleados.get(i).getsalario();
    ...
    public void buscarconceptos() {
        clstipopuesto empleadoAConsultar = new clstipopuesto();
        daotipopuesto empleadoDAO = new daotipopuesto();
        empleadoAConsultar.setid_puesto(Integer.parseInt(txtbuscado.getText()));
        empleadoAConsultar = empleadoDAO.query(empleadoAConsultar);
        txtNombre.setText(empleadoAConsultar.getnombre_puesto());
        
        cbox_estado.setSelectedItem(empleadoAConsultar.getsalario());
        
      
    }

    public frmMantenimientotipopuesto() {
        initComponents();
        llenadoDeTablas();
        llenadoDeCombos();
        estado();
    ...
    private void initComponents() {
        ...
        tablaEmpleados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_TIPO_PUESTO", "NOMBRE_PUESTO", "SALARIO"
            }
        ) {
        ...
        label4.setText("-----------------Ingreso de datos del  puesto-----------------");
        ...
        label14.setText("salario");
        getContentPane().add(label14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, -1, -1));

        getContentPane().add(cbox_estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 160, 200, -1));

        getAccessibleContext().setAccessibleName("Mantenimiento puesto");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daotipopuesto empleadoDAO = new daotipopuesto();
        clstipopuesto empleadoAEliminar = new clstipopuesto();
        empleadoAEliminar.setid_puesto(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daotipopuesto empleadoDAO = new daotipopuesto();
        clstipopuesto empleadoAInsertar = new clstipopuesto();
        empleadoAInsertar.setnombre_puesto(txtNombre.getText());
        empleadoAInsertar.setsalario(cbox_estado.getSelectedItem().toString());
...
//        // TODO add your handling code here:
        daotipopuesto empleadoDAO = new daotipopuesto();
        clstipopuesto empleadoAActualizar = new clstipopuesto();
        empleadoAActualizar.setid_puesto(Integer.parseInt(txtbuscado.getText()));
        empleadoAActualizar.setnombre_puesto(txtNombre.getText());
       
        empleadoAActualizar.setsalario(cbox_estado.getSelectedItem().toString());
