...
public class frmpais extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        daopais vendedorDAO = new daopais();
        List<clspais> vendedores = vendedorDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < vendedores.size(); i++) {
            dato[0] = Integer.toString(vendedores.get(i).getid_pais());
            dato[1] = vendedores.get(i).getnombre_pais();
    ...
    public void buscarVendedor() {
        clspais vendedorAConsultar = new clspais();
        daopais vendedorDAO = new daopais();
        vendedorAConsultar.setid_pais(Integer.parseInt(txtbuscado.getText()));
        vendedorAConsultar = vendedorDAO.query(vendedorAConsultar);
        txtNombre.setText(vendedorAConsultar.getnombre_pais());   
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if ( i == 0){
        daopais vendedorDAO = new daopais();
        clspais vendedorAEliminar = new clspais();
        vendedorAEliminar.setid_pais(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daopais vendedorDAO = new daopais();
        clspais vendedorAInsertar = new clspais();
        vendedorAInsertar.setnombre_pais(txtNombre.getText());
...
//        // TODO add your handling code here:
  int i =JOptionPane.showConfirmDialog(this, "seguro que quieres modificar este dato ");
        if ( i == 0){
        daopais vendedorDAO = new daopais();
        clspais vendedorAActualizar = new clspais();
        vendedorAActualizar.setid_pais(Integer.parseInt(txtbuscado.getText()));
        vendedorAActualizar.setnombre_pais(txtNombre.getText());
