 ...
 * @author visitante
 */
public class frmMantenimientoequipo extends javax.swing.JInternalFrame {

    public void llenadoDeCombos() {
        daoequipo EmpleadoDAO = new daoequipo();
        List<clsequipo> empleados = EmpleadoDAO.select();
        cbox_trabajadores.addItem("Seleccione una opción");
        for (int i = 0; i < empleados.size(); i++) {
            cbox_trabajadores.addItem(empleados.get(i).getnombre_equipo());
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("TORNEOS_GANADOS");
        ...
        for (int i = 0; i < empleados.size(); i++) {
           ...
           dato[0] = Integer.toString(empleados.get(i).getid_equipo());
            dato[1] = empleados.get(i).getnombre_equipo();
            dato[2] = empleados.get(i).gettorneo_ganado();
    ...
    public void buscarconceptos() {
        clsequipo empleadoAConsultar = new clsequipo();
        daoequipo empleadoDAO = new daoequipo();
        empleadoAConsultar.setid_equipo(Integer.parseInt(txtbuscado.getText()));
        empleadoAConsultar = empleadoDAO.query(empleadoAConsultar);
        txtNombre.setText(empleadoAConsultar.getnombre_equipo());
       cbox_estado.setSelectedItem(empleadoAConsultar.gettorneo_ganado());
    ...
    private void initComponents() {
        ...
        tablaEmpleados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "ID_EQUIPO", "NOMBRE_EQUIPO", "TORNEOS_GANADOS"
            }
        ) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoequipo empleadoDAO = new daoequipo();
        clsequipo empleadoAEliminar = new clsequipo();
        empleadoAEliminar.setid_equipo(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoequipo empleadoDAO = new daoequipo();
        clsequipo empleadoAInsertar = new clsequipo();
        empleadoAInsertar.setnombre_equipo(txtNombre.getText());
        empleadoAInsertar.settorneo_ganado(cbox_estado.getSelectedItem().toString());
...
//        // TODO add your handling code here:
        daoequipo empleadoDAO = new daoequipo();
        clsequipo empleadoAActualizar = new clsequipo();
        empleadoAActualizar.setid_equipo(Integer.parseInt(txtbuscado.getText()));
        empleadoAActualizar.setnombre_equipo(txtNombre.getText());
       
        empleadoAActualizar.settorneo_ganado(cbox_estado.getSelectedItem().toString());
